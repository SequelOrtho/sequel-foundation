...
```bash
npm i "@sequel/foundation@github:SequelOrtho/sequel-foundation#v0.12.1"
```
...
- **Pin a tag, not main.** Your `package.json` references a version tag (e.g. `#v0.12.1`), so foundation changes never reach your app until you choose to take them.
