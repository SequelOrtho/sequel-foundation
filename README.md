...
1. **Install** (git dependency; tag releases and pin):
   ...
   // package.json
   "dependencies": {
     "@sequel/foundation": "github:SequelOrtho/sequel-foundation#v0.14.0"
   }
   ```
